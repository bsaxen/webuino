...
It's been a while. But better late than never: New version, updated with refreshed sample content and simplified code. This is andreas09 v2.2!</p>
		...
		<div id="content" style="height:800px;">
                    <div style="float:left; width :50%; background :white;"><?viking_7_data(1);viking_7_anyFile(1);?></div>
                    <div style="float:right; width :48%; background :white;"><?viking_7_editFile(1);?></div>
                </div>
